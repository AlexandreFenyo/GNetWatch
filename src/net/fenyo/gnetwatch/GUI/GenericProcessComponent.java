 ...
 * @version $Id: GenericProcessComponent.java,v 1.2 2008/05/25 22:57:39 fenyo Exp $
 */

public class GenericProcessComponent extends BasicComponent {
  private static Log log = LogFactory.getLog(GenericProcessComponent.class);
   ...
   */
  // GUI thread
  public GenericProcessComponent(final Target target) {
    super(target);
  }
  ...
  public void windowClosing(final WindowEvent e) {
    getTarget().unregisterComponent(this, EventGenericProcess.class);
  }
