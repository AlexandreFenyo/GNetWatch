 ...
 * @version $Id: FloodComponent.java,v 1.10 2008/04/24 23:27:39 fenyo Exp $
 */

public class FloodComponent extends BasicComponent {
  private static Log log = LogFactory.getLog(FloodComponent.class);
  ...
  public void windowClosing(final WindowEvent e) {
    getTarget().unregisterComponent(this, EventFlood.class);
  }
