 ...
 * @version $Id: BytesReceivedComponent.java,v 1.8 2008/04/24 23:27:39 fenyo Exp $
 */

public class BytesReceivedComponent extends BasicComponent {
  private static Log log = LogFactory.getLog(BytesReceivedComponent.class);
   ...
   */
  // GUI thread
  public BytesReceivedComponent(final Target target) {
    super(target);
  }
  ...
  public void windowClosing(final WindowEvent e) {
    getTarget().unregisterComponent(this, EventBytesReceived.class);
  }
