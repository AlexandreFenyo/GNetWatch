 ...
 * @version $Id: ReachableView.java,v 1.22 2008/04/20 23:44:27 fenyo Exp $
 */

public class ReachableView extends DataView {
  private static Log log = LogFactory.getLog(ReachableView.class);
   ...
   */
  // GUI thread
  public ReachableView(final GUI gui, final Target target) {
    super(gui, target);
    setItem(getGUI().getConfig().getString("up_down"));
  }
  ...
  protected BasicComponent createComponent() {
    return new ChartComponent(getTarget());
  }
  ...
  protected String browserName() {
    return getGUI().getConfig().getString("ping_view");
  }
