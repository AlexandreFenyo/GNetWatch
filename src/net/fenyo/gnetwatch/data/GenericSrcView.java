 ...
 * @version $Id: GenericSrcView.java,v 1.3 2008/05/30 15:49:29 fenyo Exp $
 */

public class GenericSrcView extends DataView {
   ...
   */
  // GUI thread
  public GenericSrcView(final GUI gui, final Target target) {
    super(gui, target);
    if (getGUI() != null) setItem(getGUI().getConfig().getString("external_source"));
  }

  public GenericSrcView() {}
  ...
  protected BasicComponent createComponent() {
    return new GenericSrcComponent(getTarget());
  }
  ...
  protected String browserName() {
    return getGUI().getConfig().getString("source_view");
  }
