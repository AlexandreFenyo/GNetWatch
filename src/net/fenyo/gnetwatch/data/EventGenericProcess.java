 ...
 * @version $Id: EventGenericProcess.java,v 1.1 2008/05/21 16:46:06 fenyo Exp $
 */

public class EventGenericProcess extends EventGeneric {
   ...
   */
  // Queue thread
  public EventGenericProcess(final boolean reachable, final int delay) {
   ...
   */
  // Queue thread
  public EventGenericProcess(final boolean reachable) {
    this.reachable = reachable;
    this.delay = -1;
  }
