 ...
 * @version $Id: HTTPView.java,v 1.5 2008/04/20 23:44:27 fenyo Exp $
 */

public class HTTPView extends DataView {
  private static Log log = LogFactory.getLog(HTTPView.class);
  ...
  protected BasicComponent createComponent() {
    return new HTTPComponent(getTarget());
  }
