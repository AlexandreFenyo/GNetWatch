 ...
 * @version $Id: FloodQueue.java,v 1.10 2008/04/15 23:58:17 fenyo Exp $
 */

public class FloodQueue extends Queue implements Runnable {
  private static Log log = LogFactory.getLog(FloodQueue.class);
   ...
   */
  // main thread
  public FloodQueue(final String name, final Config config) {
    super(name, config);
    setDescription(config.getString("dedicated_for_flooding"));
  }
