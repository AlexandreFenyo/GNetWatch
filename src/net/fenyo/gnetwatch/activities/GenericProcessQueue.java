 ...
 * @version $Id: GenericProcessQueue.java,v 1.1 2008/05/21 16:46:06 fenyo Exp $
 */

public class GenericProcessQueue extends Queue implements Runnable {
  private static Log log = LogFactory.getLog(GenericProcessQueue.class);
   ...
   */
  // main thread
  public GenericProcessQueue(final String name, final Config config) {
    super(name, config);
    setDescription(config.getString("dedicated_for_external_process"));
  }
