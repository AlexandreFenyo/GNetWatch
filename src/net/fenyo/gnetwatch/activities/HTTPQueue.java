 ...
 * @version $Id: HTTPQueue.java,v 1.3 2008/04/15 23:58:17 fenyo Exp $
 */

public class HTTPQueue extends Queue implements Runnable {
  private static Log log = LogFactory.getLog(HTTPQueue.class);
   ...
   */
  // main thread
  public HTTPQueue(final String name, final Config config) {
    super(name, config);
    setDescription(config.getString("dedicated_for_http"));
  }
