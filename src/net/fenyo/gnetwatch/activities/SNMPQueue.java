 ...
 * @version $Id: SNMPQueue.java,v 1.6 2008/04/15 23:58:17 fenyo Exp $
 */

public class SNMPQueue extends Queue implements Runnable {
  private static Log log = LogFactory.getLog(SNMPQueue.class);
   ...
   */
  // main thread
  public SNMPQueue(final String name, final Config config) {
    super(name, config);
    setDescription("dedicated for SNMP queries");
  }
