 ...
 * @version $Id: NmapQueue.java,v 1.2 2008/04/15 23:58:17 fenyo Exp $
 */

public class NmapQueue extends Queue implements Runnable {
  private static Log log = LogFactory.getLog(NmapQueue.class);
   ...
   */
  // main thread
  public NmapQueue(final String name, final Config config) {
    super(name, config);
    setDescription(config.getString("dedicated_for_nmap"));
  }
